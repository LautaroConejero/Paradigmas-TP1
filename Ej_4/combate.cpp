...
int Decision_juego(){
    cout << "Momento de elgir el movimento" << endl;
...
void Accion_juego(int decision, shared_ptr<personaje>& jugador, shared_ptr<personaje>& enemigo){
    ...
    switch (resultado) {
        ...
        case 0:
            ...
            jugador->recibir_ataque(10);
            cout << "El enemigo con "<< enemigo->Get_nombre() << " ha atacado!" << endl;
            cout << "El enemigo te ataco con " << enemigo->Get_armas() << " y te hizo 10 de daño!" << endl;
        ...
        case 1:
            ...
            cout << "Tu personaje con "<< jugador->Get_nombre() << " ha atacado!" << endl;
            cout << "Tu personaje ataco con " << jugador->Get_armas() << " y le hizo 10 de daño!" << endl;
            cout << "Tu vida es: " << jugador->Get_vida() << endl;
            cout << "La vida del enemigo es: " << enemigo->Get_vida() << endl;
            break;
    }
...
int consola_combate(){
    ...
    shared_ptr<personaje> jugador = factory.Equipar_personaje(decision, cantidad_armas);
    shared_ptr<personaje> enemigo = factory.Equipar_personaje(2, cantidad_armas);
